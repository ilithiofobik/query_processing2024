...
class LoserTree {
    ...
    compare_count<std::tuple<Args...>> comp;      // Tuple comparison
   ...
   public:
    ...
    // Update the tree with the new winner
    ...
    // Get the winner of the subtree rooted at idx
